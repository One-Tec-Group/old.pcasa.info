...
class Import_leads extends App_import
{
    ...
    public function perform()
    {
        ...
        $databaseFields      = array("name", "email", "nationality", "phonenumber", "phone2", "phone3", "phone4", "skypeid", "landline", "fax", "birthdate", "passportnumber", "exipre", "email2", "email3");
...
//                elseif ($databaseFields[$i] == 'nationality') {
