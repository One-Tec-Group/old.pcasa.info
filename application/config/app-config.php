...
if (filter_input(INPUT_SERVER, "SERVER_PORT") == 80) {
    $protocol = "http://";
} else if (filter_input(INPUT_SERVER, "SERVER_PORT") == 443) {
    $protocol = "https://";
}
define('APP_BASE_URL', $protocol . filter_input(INPUT_SERVER, "SERVER_NAME") . "/");

//define('APP_BASE_URL', 'https://pcasa.info/');
...
*/
define('APP_ENC_KEY', '08ae86c55c6e7adcd7ace99aba58a335');
 ...
 */
define('APP_DB_USERNAME', 'pcasa_crmdebug');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'pcasa_crmdebug');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'pcasa_crmdebug');
