...
function app_init_admin_sidebar_menu_items() {
    ...
    $CI->app_menu->add_sidebar_menu_item('custom-menu-unique-d', [
        'name' => 'Properties', // The name if the item
        'href' => admin_url('properties'), // URL of the item
        'position' => 2, // The menu position, see below for default positions.
        'icon' => 'fa fa-building-o', // Font awesome icon
    ]);


    $CI->app_menu->add_sidebar_menu_item('custom-menu-unique-id', [
        'name' => 'Unified Bulk Import', // The name if the item
        'href' => admin_url('import'), // URL of the item
        'position' => 3, // The menu position, see below for default positions.
        'icon' => 'fa fa-upload', // Font awesome icon
    ]);
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_menu_item('properties', [
            'collapse' => true,
            'name' => "properties",
            'position' => 21,
        ]);
        $CI->app_menu->add_setup_children_item('properties', [
            'slug' => 'web-to-lead',
            'name' => "Manage Portals",
            'href' => admin_url('portals'),
            'position' => 22,
        ]);
