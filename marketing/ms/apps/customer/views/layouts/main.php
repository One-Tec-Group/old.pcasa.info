...
<body class="<?php echo str_replace("sidebar-collapse ", "", $this->bodyClasses);?>">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php if(Yii::app()->session['normalUser'] == "TRUE"){ ?>
                  ...
                  <?php }else{ ?>
                    <li class="user user-menu">
                        <a href="<?= $this->createUrl('account/logout'); ?>">
                            <i class="glyphicon glyphicon-log-out" style="transform: rotate(180deg);"></i>
                            <span><b>LOGOUT TO <?= Yii::app()->session['FromName']; ?><b/></span>
                        </a>
                    </li>
                  <?php } ?>
