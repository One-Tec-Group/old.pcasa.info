    ...
    */
    ...
    public function login() //loads home view page after login (this )
    {
        ...
        else
        {
            ...
            $this->session->set_userdata("backURLFromMarketting", $this->input->post("backURLFromMarketting"));
            $this->session->set_userdata("FromName", $this->input->post("FromName"));
    ...
    public function logout()
    {
        ...
        if($this->session->has_userdata("backURLFromMarketting") && $this->session->has_userdata("FromName")){
          redirect($this->session->userdata("backURLFromMarketting"), 'location');
        }else{
