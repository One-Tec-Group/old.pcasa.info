<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
  ...
  <div class="dropdown-menu dropdown-menu-right">
    ...
    <?php if(!($this->session->has_userdata("backURLFromMarketting")) && !($this->session->has_userdata("FromName"))){ ?>
...
<?php if($this->session->has_userdata("backURLFromMarketting") && $this->session->has_userdata("FromName")){ ?>
<li><a href="<?php echo base_url('home/logout'); ?>" class="nav-link nav-link-user"><i class="fas fa-sign-out-alt" style="transform: rotate(180deg);"></i>&nbsp;<b>LOGOUT TO <?= $this->session->userdata("FromName"); ?></b></a></li>
<?php } ?>
